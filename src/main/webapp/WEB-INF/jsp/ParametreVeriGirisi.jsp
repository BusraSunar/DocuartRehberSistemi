...
<head>
    ...
    <title>Parametre Veri Girişi</title>
...
<body>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="ParametreListesi.html">Parametre Listesi</a></li>
                                    <li class="active"><a href="ParametreVeriGirisi.html">Veri Girişi</a></li>
        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
							<form method="post" action="parametreButtons">
                            <div class="card-body card-block">
                                <div class="=row">
                                    <div class="form-group">
                                        <label for="vat" class=" form-control-label">Üst Parametre</label> 
                                        <input type="text" id="company" class="form-control col-8" name="bolumAdi" value="${bolumAdiBox}"<c:if test="${blockEnanbled == true}"><c:out value="readonly='readonly'"/></c:if>>                                   
                                    </div>
                                    <div class="form-group">
                                    	<label for="company" class=" form-control-label">Parametre</label>
                                    	<input type="text" id="company" class="form-control col-8" name="parametre" value="${parametreBox }">
                                    </div>
                                    <div class="form-group">
	                                    <label for="street" class=" form-control-label">Açıklama</label>
	                                    <textarea name="parametreAciklama" id="textarea-input" rows="6" class="form-control col-8" >${parametreAciklamaBox}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="vat" class=" form-control-label">Durum</label>
                                        <select name="dropDownParametre" id="select" class="form-control col-2">
                                            <option value="${dropDownDurum}">Please Select</option>
                                ...
                                <div class="card-body" style="text-align: right">
                                    <input type="submit" class="btn btn-outline-success btn-sm" value="Kaydet" name="parametreKaydet"<c:if test="${blockKaydet == true}"><c:out value="disabled='disabled'"/></c:if>>
                                    <input type="submit" class="btn btn-outline-primary btn-sm" value="Güncelle" name="parametreGuncelle"<c:if test="${blockGuncelle == true}"><c:out value="disabled='disabled'"/></c:if>>
                                </div>
                                  </div>
                          </form>
    ...
    <script src="assets/js/init/datatables-init.js">
