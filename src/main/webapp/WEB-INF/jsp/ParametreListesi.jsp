        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="bolumListele"><i class="menu-icon fa fa-list-ol"></i>Parametre Listesi</a></li>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="ParametreListesiSayfasi">Parametre</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <form action="BolumButtons" method="post" novalidate="novalidate">

                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Bölüm Adı</label>
                                                        <div class="input-group">

                                                            <select name="dropDownParametre" id="select" class="form-control">
                                                                <option value="${bolumList }">Please select</option>
                                                                <c:forEach items="${bolumList}" var="list">
			                                               			<option value="${list.ad}">${list.ad}</option>
			                                       				</c:forEach>
                                                            </select>
                                            ...
                                            <div>
                                                ...
                                                <div class="card-body" style="text-align:right">
                                                    <input type="submit" class="btn btn-outline-success" value="Yeni Bölüm" name="bolumYeniBolum" id ="bolumYeniBolum">&nbsp; 
                                                    <input type="submit" class="btn btn-outline-primary" value="Yeni Parametre" name="bolumYeniParametre" id = "bolumYeniParametre" disabled>&nbsp; 
                                                    <input type="button" class="btn btn-outline-danger" value="Temizle" >&nbsp;
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Parametre Listesi</strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                     <c:forEach items="${bolumList}" var="list">
                                    	<tr>
                                    		...
                                    		<td><c:out value="${list.parametre}"/></td>
                                    		<td><c:out value="${list.aciklama}"/></td>
                                    		<td class="orta">
                                                <label>
	                                                    <a href="fillParametre?id=${list.id}" class="fa fa-pencil"></a>
                                                </label>
                                            </td>
                                    	</tr>
    ...
    <script type="text/javascript">
     ...
     <script>
 		$( document ).ready(function() {
 			...
 			<c:forEach var="row" items="${bolumAdiList}">
 				nameArray.push('${row}');
 			</c:forEach>
			$( function() {
			   
			    $( "#veriSearch" ).autocomplete({
			      source: nameArray,
			      messages: {
			          noResults: '',
    	...
    	$("select").on('change',function(){
    	   if($(this).find('option:selected').text()=="Please select"){
    	       $("#bolumYeniParametre").attr('disabled',true);
       	       $("#bolumYeniBolum").attr('disabled',false);
    	   }
    	   else{
    	   		$("#bolumYeniParametre").attr('disabled',false);
   	       		$("#bolumYeniBolum").attr('disabled',true);
    	       }
    	});
    </script>
