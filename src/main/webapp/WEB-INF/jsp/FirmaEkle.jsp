        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="listeleFirma"><i class="menu-icon fa fa-suitcase"></i>Firma Ekle</a></li>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active"><a href="listeleFirma">Firma ekle</a></li>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
								<form method="post" action="buttonsFirma">
                                    <div class="form-group">
	                                    <label for="street" class=" form-control-label">Firma Adı</label>
	                                    <textarea name="firmaAdiFirma" id="textarea-input" rows="2" class="form-control col-8" >${firmaAdiFirmaBox}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="vat" class=" form-control-label">Durum</label><select name="firmaDurum" id="select" class="form-control col-2">
                                            <option value="${dropDownFirma}"></option>
	                                ...
	                                <div class="card-body" style="text-align:right">
	                                    ...
	                                    <input type="submit" class="btn btn-outline-success" value="Ekle" name="EkleFirma" <c:if test="${ekleFirma == true}"><c:out value="disabled='disabled'"/></c:if>>&nbsp; 
	                                    <input type="submit" class="btn btn-outline-primary" value="Güncelle" name="GüncelleFirma" <c:if test="${guncellemeFirma == true}"><c:out value="disabled='disabled'"/></c:if>>&nbsp; 
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Firma Listesi</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach items="${firmaList}" var="list">
                                        <tr>
                                            <td><c:out value="${list.firmaAdi}"/></td>
                                            <td><c:out value="${list.durum}"/></td>
                                            <td class="orta">
                                                <label>
	                                                    <a href="fillFirma?id=${list.id}" class="fa fa-pencil"></a>
                                                </label>
                                            </td>
                                        </tr>
                                        </c:forEach>
